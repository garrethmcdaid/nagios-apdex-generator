...
if (empty($_REQUEST['service'])) {
	...
	foreach ($monitors as $monitor => $v) {
		...
		foreach ($reports as $report => $v) {
			...
			echo "REQUIRED SAMPLES: " . number_format($samples,"0",".",",") . "<br>";
			
			echo "~~~~~~~~~~~~~~~~~~~<br>";
			
			echo "ACTUAL SATISFIED SAMPLES: " . number_format($samples_ok,"0",".",",") . "<br>";
			echo "ACTUAL TOLERATING SAMPLES: " . number_format($samples_warning,"0",".",",") . "<br>";
			echo "ACTUAL FRUSTRATED SAMPLES: " . number_format($samples_critical,"0",".",",") . "<br>";
